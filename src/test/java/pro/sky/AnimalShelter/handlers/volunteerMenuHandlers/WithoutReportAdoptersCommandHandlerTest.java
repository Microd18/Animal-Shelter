...
class WithoutReportAdoptersCommandHandlerTest {
    ...
    @InjectMocks
    private WithoutReportAdoptersCommandHandler withoutReportAdoptersCommandHandler;
    ...
    public void testHandleNotAdmin() {
        ...
        withoutReportAdoptersCommandHandler.handle(update);
    ...
    public void testGetCommand() {
        BotCommand actualCommand = withoutReportAdoptersCommandHandler.getCommand();
        assertEquals(WITHOUT_REPORT_ADOPTERS, actualCommand);
    }

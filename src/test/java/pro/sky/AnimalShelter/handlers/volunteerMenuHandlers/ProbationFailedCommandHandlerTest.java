...
class ProbationFailedCommandHandlerTest {
    @Mock
    ...
    @InjectMocks
    private ProbationFailedCommandHandler probationFailedCommandHandler;
    ...
    @Test
    @DisplayName("Проверяет, что при выполнении команды /probation_failed, если текущее состояние чата " +
    ...
    public void testHandleStateSendCorrectMessage() {
        ...
        probationFailedCommandHandler.handle(update);
    ...
    @Test
    @DisplayName("Проверяет, что метод getCommand класса ProbationFailedCommandHandler возвращает правильную команду /probation_failed")
    public void testGetCommand() {
        BotCommand actualCommand = probationFailedCommandHandler.getCommand();
        assertEquals(PROBATION_FAILED, actualCommand);
    }

...
public class VerifiedDogHandlersHandlerTest {
    ...
    public void setUp() {
        initMocks(this);
        verifiedDogHandlersHandler = new VerifiedDogHandlersHandler(chatStateService, telegramBot, commonUtils);
    ...
    public void testDocumentsListHandler() {
        Long chatId = 123L;
        BotCommand currentState = BotCommand.VERIFIED_DOG_HANDLERS;
